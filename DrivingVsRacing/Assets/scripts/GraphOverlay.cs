...
/// <summary>
/// Đây là một giải pháp vẽ đồ thị thực sự đơn giản cho độ trượt ma sát của WheelCollider.
/// </summary> 
public class GraphOverlay : MonoBehaviour
{
	...
	void Start()
	{
        ...
        // Thiết lập kết cấu của chúng ta.
	...
	void FixedUpdate()
	{
		foreach (var wheelConfig in wheelConfigs)
		{
            ...
            if (Mathf.Abs(timeTravel) < k_MaxRecordTimeTravel)// VIỆC CẦN LÀM: giải quyết bí ẩn này
            {
    ...
    // Chuyển giá trị thời gian thành không gian đồ thị pixel.
