...
public class controller : MonoBehaviour
{
    ...
    [HideInInspector]public bool test; // boolean âm thanh động cơ
    ...
    private void steerVehicle(){
        ...
        // công thức lái ackerman
        //steerAngle = Mathf.Rad2Deg * Mathf.Atan(2.55f / (radius + (1.5f / 2))) * horizontalInput;

        if (horizontal > 0 ) {
            // track size after set to 1,5f. Bánh cơ sở đã được đặt thành 2,55f
    ...
    private void adjustTraction(){
        // mất thời gian để đi từ ổ đĩa bình thường để trôi
        ...
        // được thực thi khi phanh tay đang được giữ
        else
        {
        ...
        // kiểm tra lượng trượt để kiểm soát độ trôi
        for (int i = 2;i<4 ;i++){
